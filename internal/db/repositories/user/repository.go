...
func (u *RepositoryImpl) Update(ctx context.Context, id string, updatePayload *identityDTO.UpdateUserRequest) (string, error) {
	log := u.repositoryLog.Method("Update").WithContext(ctx)
...
func (u *RepositoryImpl) SoftDelete(ctx context.Context, id string) (string, error) {
	log := u.repositoryLog.Method("SoftDelete").WithContext(ctx)
...
func (u *RepositoryImpl) HardDelete(ctx context.Context, id string) (string, error) {
	log := u.repositoryLog.Method("HardDelete").WithContext(ctx)
